...
public class CollectionsMain extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        //@ Creazione del model: 3 stones diverse e uno stack che le contiene
        ...
        //@ Creazione dei controller, uno per ogni elemento del model
        //@ Una lista di controller per ogni `StoneBlock`
        ArrayList<StoneBlockController> asc = new ArrayList<>();
        asc.add(sc0); asc.add(sc1); asc.add(sc2);
        //@ E un controller per lo stack, al quale passiamo il controller dei blocks
