...
public class MediaMedianaModa {
    ...
    public static double calcolaMedia(int[] array) {
        ...
        double somma = 0;
        for (int valore : array) {  // int valore : array -> ad ogni ciclo, prende in sequenza un elemento dall'array e lo assegna temporaneamente alla variabile valore
            somma += valore;
        }
